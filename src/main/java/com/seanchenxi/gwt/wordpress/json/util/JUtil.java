...
public class JUtil {
	...
	/**
	 * Convert a {@link com.google.gwt.core.client.JsArray} to {@link java.util.ArrayList}
	 * @param jsList
	 * @return
	 */
	...
	/**
	 * Convert a {@link String} in format "yyyy-MM-dd HH:mm:ss" to {@link java.util.Date} 
	...
	/**
	 * Convert a {@link java.util.Date} to {@link String} "yyyy-MM-dd HH:mm:ss"
	 * @param date
